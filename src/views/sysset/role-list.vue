<template>
  <div class="app-container calendar-list-container">
    <div class="filter-container">
      <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" :placeholder="$t('user.name')" v-model="listQuery.userName">
      </el-input>
<!--       <el-select clearable style="width: 90px" class="filter-item" v-model="listQuery.importance" :placeholder="$t('table.importance')">
        <el-option v-for="item in importanceOptions" :key="item" :label="item" :value="item">
        </el-option>
      </el-select> -->
      <el-select clearable @change='handleFilter' class="filter-item" style="width: 130px" v-model="listQuery.sex" :placeholder="$t('user.sex')">
...
<!--       <el-select @change='handleFilter' style="width: 140px" class="filter-item" v-model="listQuery.sort">
      ...
      <el-input  style="width: 200px;" class="filter-item" :placeholder="$t('user.email')" v-model="listQuery.email">
      </el-input>
...
<!--       <el-table-column min-width="150px" :label="$t('user.name')">
        <template slot-scope="scope">
...
<!--       <el-table-column width="110px" v-if='showReviewer' align="center" :label="$t('table.reviewer')">
      ...
      <el-table-column width="60px" :label="$t('user.sex')" align="center">
        <template slot-scope="scope">
...
<!--         <el-form-item :label="$t('user.name')" prop="type">
        ...
        <el-form-item :label="$t('user.email')" prop="email">
          <el-input v-model="temp.email" :placeholder="$t('user.placeholder.email')"></el-input>
        </el-form-item>
...
import { fetchList, create, update } from '@/api/role'
...
const calendarSexKeyValue = sexOptions.reduce((acc, cur) => {
...
export default {
  ...
  data() {
    ...
    return {
      ...
      statusOptions: ['NOMAIL', 'DELETED', 'LOCKED'],
      // showReviewer: false,
      temp: {
        id: undefined,
        userName: 'xx',
  ...
  filters: {
    ...
    sexFilter: function(sex) {
      return calendarSexKeyValue[sex]
    }
  },
  created() {
    this.getList()
